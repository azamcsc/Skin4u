...
import 'package:customers_app/screens/question/question6.dart';
...
class Question5 extends StatelessWidget{
  ...
  const Question5({Key? key, this.text, this.onTap, this.image}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do you get acne easily?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("The acne can pop even if it is not related to hormone changes", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
      ...
      // ),
                  ...
                  child: ElevatedButton(
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Question6()));
                  },
                  child: Text("NO"),
                  style: ElevatedButton.styleFrom(
                  primary: almondBrownColor,
