...
import 'package:customers_app/screens/question/question9.dart';
...
class Question8 extends StatelessWidget{
  ...
  const Question8({Key? key, this.text, this.onTap, this.image}) : super(key: key);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("The apprearance of the pores is quite visible to the eye.", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Question9()));
                  },
                  child: Text("YES"),
