...
class Question7 extends StatelessWidget{
  ...
  const Question7({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do you somehow experience flaky skin?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("It probably occur once on the cheeks or chin area.", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Diagnosis1Pages()));
                  },
                  child: Text("YES"),
