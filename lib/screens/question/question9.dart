import 'package:customers_app/screens/question/question10.dart';
...
class Question9 extends StatelessWidget{
  ...
  const Question9({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do you often feel your skin to be oily in the morning?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("It is when you wake up from sleep.", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Question10()));
                  },
                  child: Text("YES"),
