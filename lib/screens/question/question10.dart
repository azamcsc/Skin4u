import 'package:customers_app/screens/diagnosis/diagnosis2.dart';
...
class Question10 extends StatelessWidget{
  ...
  const Question10({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Does your skin feels greasy and thick throughout the day?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("It is usually appears to be shiny.", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Diagnosis2Pages()));
                  },
                  child: Text("YES"),
