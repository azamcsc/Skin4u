import 'package:customers_app/screens/diagnosis/diagnosis3.dart';
...
class Question13 extends StatelessWidget{
  ...
  const Question13({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do you describe yourself as hydrated?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("The skin is always appears to be supple.", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Diagnosis3Pages()));
                  },
                  child: Text("YES"),
