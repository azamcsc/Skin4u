import 'package:customers_app/screens/question/question13.dart';
...
class Question12 extends StatelessWidget{
  ...
  const Question12({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do you rarely or never have flaky skin?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("Never experience tightness on the skin/", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
                ...
                Container(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => Question13()));
                  },
                  child: Text("YES"),
