import 'package:customers_app/screens/diagnosis/diagnosis1.dart';
import 'package:customers_app/screens/question/question4.dart';
...
class Question3 extends StatelessWidget{
  ...
  const Question3({Key? key, this.text, this.onTap, this.image}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Do experience skin tightness?", 
                  style: regularTextStyle.copyWith(fontSize: 25),
                  ),
                SizedBox(height: 8,
                ),
                Text("Usually after washing your face", style: regularTextStyle.copyWith(fontSize: 15, color: almondBrownColor),
                ),
                SizedBox(height:20),
  ...
  //             (text: "GET STARTED", 
  //             onTap: (){
  //               Navigator.pushReplacement(context, MaterialPageRoute (builder: (context) => DiagnosisPages()));
  //             },
  //             )
  //           ,)
  //           ],
