...
class _DoctorDetailState extends State<DoctorDetailPage> {
  ...
  Widget initWidget(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: Color.fromARGB(255, 239, 178, 153),
        centerTitle: true,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: Color.fromARGB(255, 239, 178, 153),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('Certified Dermatologist',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 15,
                                fontFamily: 'Roboto',
                          ...
                          Container(
                            ...
                            child: Text('SKIN4U Clinic, Pasir Gudang',
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 15,
                                fontFamily: 'Roboto',
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: [
                  doctorTimingsData("10:30 AM", true),
                  doctorTimingsData("12:30 AM", false),
                  doctorTimingsData("02:30 PM", false),
